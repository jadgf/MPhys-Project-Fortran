...
!--------to be modified by the user
    ...
    integer,parameter::xmeshres=10,ymeshres=10,zmeshres=10,ares=2,nkxpoints=(2*xmeshres+1),nkypoints=(2*ymeshres+1),nkzpoints=(2*zmeshres+1),napoints=(2*ares+1),nbmin=12,nbmax=13,&
